    ...
    <tr>
      <td width="25%"><table width="100%" border="0" cellspacing="0" style="margin-top:30px">
        ...
        <tr>
		  ...
		  <a href=""${pageContext.request.contextPath }//dispacher.do?type=modifyuserinfo">用户信息修改</a></td>
        </tr>
...
<tr>
      ...
      <td><div style="text-align:right; margin:5px 10px 5px 0px"><a href="${pageContext.request.contextPath }/index.do">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/dispacher.do?type=successful">&nbsp;我的帐户</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;用户信息修改</div>
  ...
  <tr>
    ...
    <td><input name="upassword" class="textinput"/></td>
  ...
  <tr>
    ...
    <td colspan="2">&nbsp;&nbsp;<input type="radio" name="usex" value="男" <c:if test="${user.usex=='男' }">checked</c:if> />
      男
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="usex" value="女" <c:if test="${user.usex=='女' }">checked</c:if> />
女</td>
    </tr>
  <tr>
    ...
    <td>&nbsp;</td>
		  ...
		  <table width="100%" border="0" cellspacing="2" class="upline">
            <tr>
              ...
              <td width="47%" style="width:50%"><select name="aqustion"  class="textinput" style="width:230px; height:20px ">
                  <option value="${upasswordAnswer.aquestion }" >${upasswordAnswer.aquestion }</option>
            ...
            <tr>
              ...
              <td colspan="2"><input  type="text" class="textinput" value="${upasswordAnswer.answer }" name="answer"/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font color="#999999">不能少于4个字符，不区分大小写</font></td>
            </tr>
            <tr>
              <td style="text-align:right">备用邮箱：</td>
              <td><input name="email" type="text" class="textinput" value="${upasswordAnswer.amail }"/></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td style="text-align:right">&nbsp;</td>
		  ...
		  <p style="text-align:center"><input type="image" src="${pageContext.request.contextPath }/images/botton_gif_025.gif" border="0" /></input></p>
