          ...
          <td><table width="100%" border="0" cellspacing="0">
              <tr>
                <td><img src="images/buy3.gif" width="635" height="38" />
                  <p>早上好：XXX先生！您的购买流程还有最后一步啦</p></td>
              </tr>
              <tr>
             ...
             <c:forEach var="listi" items="${sessionScope.sessionList}">
              ...
              <%-- --%>
				   ...
				   <hr/> 
				   <p style="text-align:center"><a href="${pageContext.request.contextPath }/dispacher.do?type=success2&totalPrice=${salary }"><img src="images/finalbutton.gif" width="204" height="51" border="0" /></a></p></td>
                  </c:forEach>
              </tr>
            </table></td>
        </tr>
