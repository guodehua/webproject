...
<script src="${pageContext.request.contextPath }/js/checName.js" type="text/javascript" charset="utf-8"></script>
</head>
<body class="main">
<%--导入header --%>
...
<table width="70%" border="0" cellspacing="2" class="upline">
  <tr>
    ...
    <td><img src="images/check_use.gif" width="111" height="24" /><span id='esp'></span></td>
  </tr>
  <tr>
    <td style="text-align:right">会员名：</td>
    <td><input type="text" class="textinput" name="uname" id="uname"/></td>
    <td><img id="check_user" type="image" src="${pageContext.request.contextPath }/images/check_use.gif" width="111" height="24" /><span id='sp'></span></td>
  </tr>
  <tr>
...
<option value="您的第一辆汽车或自行车是什么牌子的？" >您的第一辆汽车或自行车是什么牌子的？</option>
  ...
  <tr>
    ...
    <td colspan="2"><input type="text" class="textinput" name="answer"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <font color="#999999">不能少于4个字符，不区分大小写</font></td>
    </tr>
    <tr>
    <td style="text-align:right">备用邮箱：</td>
    <td><input type="text" class="textinput" name="amail"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td style="text-align:right">&nbsp;</td>
...
<table width="80%" border="0" cellspacing="2" class="upline">
  <tr>
    ...
    <td style="width:50%"><input type="text" class="textinput" name="uinputpassword"/><img style="width:25%;" src="${pageContext.request.contextPath }/imag.do"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td style="text-align:right">&nbsp;</td>
...
<table width="70%" border="0" cellspacing="0">
  <tr>
    <td style="padding-top:20px; text-align:center"></a></td>
    <input type="image" href="${pageContext.request.contextPath }/dispacher.do?type=registersuccess" src="images/signup.gif" border="0" /></input>
  </tr>
</table></td>
    </tr>
</table>
